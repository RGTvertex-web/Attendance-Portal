...
_PERFORMANCE_COLS = {
    "report_id": 0, "intern_id": 1, "manager_id": 2, "report_type": 3,
    "rating": 4, "discipline": 5, "feedback": 6, "created_at": 7,
}
_INVITES_COLS = {
...
SHEET_HEADERS = {
    ...
    "Performance": ["report_id", "intern_id", "manager_id", "report_type", "rating", "discipline", "feedback", "created_at"],
...
def create_performance_report(intern_id: str, manager_id: str, report_type: str,
                              rating: str, discipline: str, feedback: str) -> Dict:
    sheet = _get_sheet("Performance")
    report_id = _new_id()
    created_at = _now_utc_str()
    row = [report_id, intern_id, manager_id, report_type, rating, discipline, feedback.strip(), created_at]
    sheet.append_row(row, value_input_option="RAW")
